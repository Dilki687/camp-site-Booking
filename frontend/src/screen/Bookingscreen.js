...
function Bookingscreen() {
    ...
    const fetchCamplocation = async () => {
      try {
        ...
        const response = await axios.post(
          "/api/camplocations/getcamplocationbyid",
          { camplocationid }
        );
  ...
  async function onToken(token) {
    ...
    try {
      ...
      if (bookingId) {
        ...
        result = await axios.post("/api/bookings/updatebooking", bookingDetails);
        Swal.fire("Updated", "Booking updated successfully", "success").then(() => {
          navigate("/profile");
        });
      } else {
        // New booking
        result = await axios.post("/api/bookings/bookcamplocation", bookingDetails);
  ...
  const handleUpdatedData = async () => {
    ...
    try {
      ...
      const result = await axios.post("/api/bookings/updatebooking", bookingDetails);
      Swal.fire("Updated", "Booking updated successfully", "success").then(() => {
        navigate("/profile");
      });
    } catch (error) {
